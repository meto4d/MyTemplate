...
inline void SwapP(void *a, void *b) {
	_asm {
		MOV EBX, a
		MOV EDX, b
		MOV EAX, [EBX]
...
// glewをCmakeしたかバイナリ配布しか使ってないか
#define GLEW_CMAKED 1

#pragma comment(lib, "opengl32.lib")

// ビルドモード
#ifdef _DEBUG
#define GL_DIR_STR "Debug/"
#define GL_EXT_STR "d.lib"
#else
#define GL_DIR_STR "Release/"
#define GL_EXT_STR ".lib"
#endif
#ifdef _WIN64
#define GLEW_BIT_STR "x64/"
#else
#define GLEW_BIT_STR "Win32/"
#endif

//GLEW(GLSL)
// MinSizeRelやRelWithDebInfoにリンクさせてません
#include <GL/glew.h>
#include <GL/wglew.h>
#if GLEW_CMAKED
	#pragma comment(lib, GL_DIR_STR GLEW_BIT_STR "glew32" GL_EXT_STR)
	#pragma comment(lib, GL_DIR_STR GLEW_BIT_STR "libglew32" GL_EXT_STR)
#else
	//「glew32s.lib」は「static」という意味らしく「glew.dll」が不要。
	//「glew32.lib」は「glew.dll」を呼出すプログラムにスタティックにリンクする
	#pragma comment(lib, "Release/" GLEW_BIT_STR "glew32.lib")
	#pragma comment(lib, "Release/" GLEW_BIT_STR "glew32s.lib")
#endif
// 昔のやつ ver < 2.0.0
...
//// freeglut < 3.0.0
//#if !defined _WIN64
//#pragma comment(lib, "x86/freeglut" GL_EXT_STR)
//#else
//#pragma comment(lib, "x64/freeglut" GL_EXT_STR)
//#endif

//GLext：Win32 OpenGL Extension API
//https://ja.osdn.net/projects/sfnet_glextwin32/howto/usage
#include <GL/glext.h>
